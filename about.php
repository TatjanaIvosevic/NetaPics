      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-6 content order-last  order-lg-first">
            <h3>O nama</h3>
            <p>
              Ova stranica je kreirana sa željom da spojimo različiote ukuse naših talentovanih fotgrafa širom sveta.
            </p>
            <ul>
              ...
              <li data-aos="fade-up" data-aos-delay="200">
                ...
                <div>
                  <h5>Otpremi</h5>
                  <p>svoje radove kojima se ponosiš.</p>
                </div>
              </li>
              <li data-aos="fade-up" data-aos-delay="300">
                ...
                <div>
                  <h5>Preuzmi</h5>
                  <p>radove drugih fotografa i daj im znak podrške.</p>
                </div>
              </li>
            </ul>
          </div>
